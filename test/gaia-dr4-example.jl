...
# Construct Gaia DR4 observation likelihood
...
b = Planet(
    ...
    observations=[],
    solver=PlanetOrbits.Markley(),  # Explicit solver avoids Enzyme shadowing Auto()'s e>=1 fallback
    variables=@variables begin
...
t = [
 -1.6495356151026312
 -6.491790601708638
  0.029738626170779867
  0.0832180348920664
  0.010814871781942643
 -0.04826697440973689
 -3.357219015634567
  0.1154498724014276
 -0.012059033319817353
 -0.4030642907378578
 -2.391709856749899
  0.21726752142249556
 -4.866247384968242
...
# test it once
model.ℓπcallback(t) # isapprox 132.50998916711984


#primal, grad = model.∇ℓπcallback(t)
# primal isapprox 132.50998916711984
# grad isapprox [-0.0005554893442992759, 1.592991672477338e-7, -4.298554218188531e-5, 6.223104889555368e-5, -0.020372812771732196, 0.02627009994154831, 8.459059177186312e-6, -4.59962866458663e-6, 6.786563689957503e-6, 1.1863688740509915e-5, 9.518254022400363e-6, -2.811051135115372e-6, -6.8209395289661745e-6]
...
# @code_warntype model.∇ℓπcallback(t)
